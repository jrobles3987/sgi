                  ...
                  <div class="box-header with-border">
                    <h4 class="box-title" style="font-size: 25px;">
                      <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                        Incidencias generadas EN CURSO
                        <span class="caret"></span>
                      </a>
                    </h4>
                  </div>
                  ...
                  <div class="box-header with-border">
                    <h4 class="box-title" style="font-size: 25px;">
                      <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                        Incidencias generadas EN OBSERVACIÓN
                        <span class="caret"></span>
                      </a>
                    </h4>
                  </div>
                  ...
                  <div class="box-header with-border">
                    <h4 class="box-title" style="font-size: 25px;">
                      <a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">
                        Incidencias generadas RESUELTAS
                        <span class="caret"></span>
                      </a>
                    </h4>
                  </div>
                  <div id="collapseFour" class="panel-collapse collapse">
                    <div class="box-body">
                    	<div id="incidentes_resuletas">
							<TABLE id="tablaincidencias4" class="table table-striped table-bordered table-hover">
								<?php
									echo '<THEAD>';
									echo '<TR><TH>N°</TH><TH>Titulo</TH><TH>Estado</TH><TH>Fecha Apertura</TH><TH>Prioridad</TH><TH>Solicitante</TH><TH>Asignado A:</TH><TH>Ultima Modificacion</TH><TH>Fecha Vencimiento</TH></TR>';
									echo '</THEAD>';
