...
<head>
  ...
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?=base_url()?>plantilla/plugins/daterangepicker/daterangepicker.css">
...
<!-- FastClick -->
<script src="<?=base_url()?>plantilla/plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="<?=base_url()?>plantilla/dist/js/app.min.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?=base_url()?>plantilla/dist/js/pages/dashboard.js"></script>
