...
class Consultas_insidencias extends CI_Controller {
  ...
  public function get_insidencias($fecha_inicio = '',$fecha_fin = ''){
    ...
    $html2pdf->pdf->SetTitle('Parte Diaria Enfermeria');
            ...
            //OBTENIENDO DATOS ENFERMERA
        	  	// $enfermera = $this->enfermeria_model->get_datos_enfermera($id_enfermeria);
              //contador
            ...
            $html .= '<table id="tablaBloque" class="width100">
                ...
                foreach ($inci as $row) {
                  ...
                  $html .= '
                      <td class="hheaderblue t4 center" width="120">'.$row->tecnicoasignado.'</td>';
                  $html .= '
...
$num +=1;
              ...
              try{
                ...
                $html2pdf->Output('Parte Enfermeria.pdf');
