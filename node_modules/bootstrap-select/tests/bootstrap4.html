...
<body>
<nav class="navbar navbar-light bg-light fixed-top navbar-expand-lg" role="navigation">
  <div class="container">
  ...
  <ul class="navbar-nav mr-auto">
    ...
    <li class="nav-item active">
      <select id="basic" class="selectpicker show-tick form-control" data-live-search="true" data-width="fit">
        <option>cow</option>
...
<select class="selectpicker" data-live-search="true">
    <option data-subtext="ST">Some text</option>
    <option data-subtext="123">Some other text</option>
</select>
<div class="btn-group">
  ...
  <div class="dropdown-menu">
    <form class="px-4 py-3">
      ...
      <select class="selectpicker form-control" data-live-search="true" title="Select a number" data-hide-disabled="true">
        <option>Woo</option>
        <option>Foo</option>
      </select>
  ...
  <form role="form">
    <div class="form-group row">
      <div class="offset-md-3 col-md-5">
        <select class="selectpicker form-control" data-container="body" data-live-search="true" title="Select services" data-hide-disabled="true" data-style="" data-style-base="form-control" data-width="auto" multiple>
          <optgroup label="Belts and Hoses">
            <option>Timing Belt</option>
            <option>Serpentine Belt</option>
            <option>Coolant Hoses</option>
          </optgroup>
          <optgroup label="Steering, Suspension and Alignment">
            <option>Steering Repair</option>
            <option>Car Suspension</option>
...
<div class="container">
  ...
  <div class="input-group">
    ...
    <select class="form-control selectpicker" data-style="btn-outline-secondary">
      <option>One</option>
      <option>Two</option>
      <option>Three</option>
    </select>
  ...
  <hr>
  <div class="input-group">
    <select class="form-control selectpicker" data-mobile="true" data-style="btn-outline-secondary">
      <option>One</option>
      <option>Two</option>
      <option>Three</option>
    </select>
  ...
  <hr>
  <select id="done" class="selectpicker" multiple data-done-button="true" data-show-subtext="true" data-selected-text-format="count > 0">
    <option selected>
      Apple
    </option>
    <option selected data-subtext="Wooo">
      Banana
      </option>
    <option>Orange</option>
    <option>Pineapple</option>
...
$.fn.selectpicker.Constructor.DEFAULTS.style = 'btn-outline-dark';
...
$('.selectpicker').on('changed.bs.select', function(e, clickedIndex, isSelected, oldValue) {
  //console.log(clickedIndex);
  //console.log(isSelected);
  //console.log(oldValue);
});

$('.btn-group').children('.dropdown-menu').on('click', function(e) {
